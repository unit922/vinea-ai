...
const IntelligenceAcademy: React.FC<IntelligenceAcademyProps> = ({ 
  ...
  const [messages, setMessages] = useState<{role: 'user' | 'vinetelligence', text: string, feedback?: number}[]>([
    { role: 'vinetelligence', text: `Vinetelligence Academy operational. System tuned for ${userRole} level technical coaching. Inquire about vintages, chemistry, or protocols.` }
  ]);
                 ...
                 <div className="space-y-4">
                    ...
                    {filteredModules.map(m => (
                      <div 
                        ...
                        className="bg-white p-6 rounded-3xl border border-stone-100 hover:border-indigo-500 transition-all cursor-pointer group shadow-sm hover:shadow-md"
                      >
