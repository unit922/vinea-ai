...
const POSSimulator: React.FC<POSSimulatorProps> = ({ onClose, restaurantName }) => {
  ...
  // Remove the useEffect that was loading from localStorage
  ...
  const handleCheckout = () => {
    ...
    setTimeout(() => {
      ...
      const currentInv = JSON.parse(localStorage.getItem('vinetelligence_inventory') || localStorage.getItem('vinea_inventory') || '[]');
